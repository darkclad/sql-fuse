...
public:
    ...
    // Database operations - SQLite has a single database per file
    ...
    // Routine operations - SQLite doesn't have stored procedures
    ...
    // Server info - SQLite version info
...
private:
    ...
    std::string m_databaseName;  // Derived from file path
};
